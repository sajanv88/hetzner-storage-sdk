...
export class ObjectStorageProvider extends BaseStorageProvider {
    ...
    constructor(config: ObjectStorageConfig) {
        ...
        this.s3Client = new S3ApiClient(config.accessKeyId, config.secretAccessKey, config.region);
    ...
    async uploadFile(
        ...
        await this.s3Client.putObject(this.defaultBucket, key, body, options?.contentType);
    }
