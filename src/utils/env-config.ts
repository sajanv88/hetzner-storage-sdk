 ...
 */
export function mergeWithEnv<T extends Partial<StorageBoxConfig | StorageShareConfig | ObjectStorageConfig>>(
  provided: T,
  envConfig: Partial<StorageBoxConfig | StorageShareConfig | ObjectStorageConfig>
): T {
  return {
    ...envConfig,
    ...provided,
